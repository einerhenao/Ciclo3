    ...
    $.ajax({
        ...
        success:function(json){
            ...
            for (i=0; i<json.items.length; i++){
                ...
                filas += "<td>" + `<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" readonly onmousedown="return false;">`+ json.items[i].messagetext + "</textarea></td>";
